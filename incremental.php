			   ...
			   <h3 class="text-dark mt-0">Alur Metodologi (Gambar dan penjelasan)</h3>
                ...
                <p>
                  ...
                  <h4 class="text-dark mt-0">Sumber : </h4> 
                   [1] Fanani, Mukhamad., Sholiq., Muqtadiroh, Feby.(2015,November).Implementasi metode incremental dalam membangun aplikasi use case point pada perusahaan DTS.Seminar Nasional Informasi Indonesia.172-173. <br></br>
                   [2] P. Roger S, Sogtware Engineering : A Practitioner's Approach, 7th Edition, New York: Mc Graw-Hill, 2010. <br></br>
                   [3] I. Sommerville, Software Engineering, 9th Edition, Addison Wesley, 2011. <br></br>
                   [4] <a href="https://masyudit.blogspot.com/2019/09/pengertian-kelebihan-dan-kekurangan.html" style="color:white">https://masyudit.blogspot.com/2019/09/pengertian-kelebihan-dan-kekurangan.html</a> diakses pada 08 september 2020 pukul 2.50 pm <br></br>
                   [5] <a href="https://software.endy.muhardin.com/manajemen/release-management/" style="color:white"> https://software.endy.muhardin.com/manajemen/release-management/ </a>  diakses pada 08 september 2020 pukul 3.55 pm <br></br>
                    </ul>
                </p>
               </p>
            </div>
